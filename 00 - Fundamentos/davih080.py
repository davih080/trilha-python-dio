...
class ContaCorrente(Conta):
    ...
    @classmethod
    def nova_conta(cls, cliente, numero, senha, limite=500, limite_saques=3):
        return cls(numero, cliente, senha, limite, limite_saques)
...
class Historico:
    ...
    def transacoes_do_dia(self):
        ...
        return [t for t in self.transacoes if t["data"].startswith(hoje)]
...
def recuperar_conta_cliente(cliente):
    ...
    try:
        ...
        if 0 <= index < len(cliente.contas):
            ...
            print("\n@@@ Conta inválida selecionada! @@@")
    except ValueError:
        print("\n@@@ Entrada inválida! @@@")
    return None


def executar_transacao(clientes, tipo):
...
def criar_conta(numero_conta, clientes, contas):
    ...
    conta = ContaCorrente.nova_conta(cliente, numero_conta, senha)
    contas.append(conta)
...
def main():
    print("\n>>> Bem-vindo ao Banco Santander 32 horas <<<\n")
    ...
    while True:
        ...
        if opcao == "d":
            ...
            print("\n>>> Obrigado por usar o Caixa Santander 32 horas <<<")
            break
        else:
